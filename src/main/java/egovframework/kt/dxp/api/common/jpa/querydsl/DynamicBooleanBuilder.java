package egovframework.kt.dxp.api.common.jpa.querydsl;
...
import egovframework.kt.dxp.api.common.jpa.DynamicConditions;
import egovframework.kt.dxp.api.common.jpa.annotations.DefaultSort;
import egovframework.kt.dxp.api.common.jpa.annotations.NumericOrder;
import egovframework.kt.dxp.api.common.request.DynamicFilter;
import egovframework.kt.dxp.api.common.request.DynamicSorter;
    ...
    public BooleanBuilder generateConditions(Class<?> entity, List<DynamicFilter> dynamicFilters) {
        ...
        for (DynamicFilter dynamicFilter : dynamicFilters) {
            if (ObjectUtils.isEmpty(dynamicFilter.operator())) {
                throw new ServiceException(ErrorCode.INVALID_PARAMETER, "Invalid operator. Possible Operators -> " + Operator.getOperatorString());
            }
            PathBuilder<Object> root = new PathBuilder<>(entity, lowerCaseFirst(entity.getSimpleName()));
